const labels={
    ...
    signup_opt1: {name: 'option1', placeholder: 'option1',key:'_signup_opt1'},
    signup_opt2: {name: 'option2', placeholder: 'option2',key:'_signup_opt2'},
    signup_opt3: {name: 'option3', placeholder: 'option3',key:'_signup_opt3'},
    signup_opt4: {name: 'option4', placeholder: 'option4',key:'_signup_opt4'}
}
